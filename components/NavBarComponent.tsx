...
export default function NavBarComponent() {
  ...
  return (
    <div className="box-border m-5 flex justify-between items-center">
        <div className="bg-slate-100 inline-block p-3 text-3xl my-3">Battle<span className="text-red-600">Grounds</span></div>
        {
          user && (
            ...
            <div className="links flex-row">
                <Link href="/Tournaments"><span className="text-lg font-semibold hover:text-red-600 hover:border-b-2 hover:border-black">Tournaments</span></Link>
            </div>
